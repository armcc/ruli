...
/**************************************************************************
 * FUNCTION NAME : show_srv_list
 **************************************************************************
 * DESCRIPTION   :
 * Walk through the SRV answer records and print them on the console / 
 * STDOUT.
 *************************************************************************/
    ...
    */
    for (i = 0; i < srv_list_size; ++i) {
        ...
        */
        ...
        printf("priority=%d weight=%d port=%d ttl= %d addresses=", 
	        entry->priority, entry->weight, entry->port, entry->ttl);
